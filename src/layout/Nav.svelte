        ...
        <nav class="container-fluid pb-0 "  >
            <div class="row justify-content-end px-0 px-md-2 px-lg-5 " >
                ...
                <div class="col-9 col-sm-7 col-custom pr-0 pl-2 ">
                    <div class="row ">
                        <div class="col-12 ">
                            <div class="menu-main-element row {x<300 ? 'justify-content-center' : 'justify-content-start'} {x<260 ? 'justify-content-between px-4' : 'justify-content-start'} {x<242 ? 'justify-content-end' : 'justify-content-start'}  mt-1" style="direction: rtl;text-align: center;">
                                <div class="col-2 ">
